...
<!-- Archived 2026-04-10: Never sleep() in callbacks → robust-testing skill (Section 2) + developing-python (Background Daemons) -->
<!-- Archived 2026-04-10: Tkinter from daemon threads kills pystray → robust-testing skill (Section 3) + developing-python (Background Daemons) -->
<!-- Archived 2026-04-10: Model parameter coupling → robust-testing skill (Section 7) + feedback_model_parameter_coupling.md memory -->
